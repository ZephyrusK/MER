...
public class DiagnosisController {		//诊断信息
	...
	public ModelAndView advice_medical(){//	  病历---	病历jsp
		ModelAndView mv=new ModelAndView("/advice/medical");
		mv.addObject("courseType", iDiseaserecordService.courseType());		
		return mv;
	}
	
	@RequestMapping("medical_Insert")
	...
	public ModelAndView advice_diagnosis(){//	  病历---	诊断jsp
	...
	@RequestMapping("diagnosis_Insert")//诊断新增
	...
	public ModelAndView advice_advice(){//	  病历---	医嘱jsp
		ModelAndView mv=new ModelAndView("/advice/advice");
	...
	@ResponseBody//医嘱---绑定药物的规格、单位、途径属性
	...
	@RequestMapping("advice_Insert")//医嘱新增
	...
	public  ModelAndView advice_test_apply(){	//	  病历---	To检验申请jsp
		ModelAndView mv=new ModelAndView("/advice/test_apply");
		mv.addObject("testItem", iTestService.testitem()); //绑定检验项目
		mv.addObject("sample", iTestService.sample());	   //绑定样本
		return mv;
	}
	
	@ResponseBody//检查申请---绑定单位、参考范围
	...
	@RequestMapping("test_Insert")//检验申请新增 
	...
	public ModelAndView advice_check_apply(){//	  病历---	To检查申请
		ModelAndView mv=new ModelAndView("/advice/check_apply");
	...
	public List<Checkitem> checkItem(int checkDepartmentID){//	 检查项目
		List<Checkitem> checkitem=iCcheckService.checkItem(checkDepartmentID);
		return checkitem;
	}
	
	@RequestMapping("checkInsert")
	public ModelAndView checkInsert(Ccheck ccheck,HttpSession session){//	 Insert检查
		ModelAndView mv=new ModelAndView("/advice/check_apply");
